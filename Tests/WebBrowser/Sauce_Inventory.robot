*** Settings ***
Documentation               Example Robot Framework suite for automation tests against SauceDemo web page login using BrowserLibrary
Resource                    ../../Data/InputData.robot
Resource                    ../../Resources/CommonBrowser.robot
Resource                    ../../Resources/WebBrowser/SauceApp.robot
Test Setup                  CommonBrowser.Start Web Test And Login
